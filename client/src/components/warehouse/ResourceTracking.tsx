...
import { Truck, PackageOpen, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between p-2 bg-[hsl(0,0%,17.6%)] rounded">
          <div className="flex items-center space-x-3">
            <PackageOpen className="h-4 w-4 text-[hsl(265,89%,78%)]" />
            <span className="text-sm text-[hsl(0,0%,88.2%)]">BOPTs</span>
            <Badge className="bg-[hsl(265,89%,78%)] text-black text-xs px-2 py-1">
              5 Active
            </Badge>
          </div>
          <Button
